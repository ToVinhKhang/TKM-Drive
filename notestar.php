    ...
    <div>
        <div class="row">
            <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                ...
                <nav class="navbar navbar-light ">
                    <ul id="ulmenu" class="navbar-nav nav nav-pills">
                        ...
                        <div class="dropdown-divider"></div>
                        <li id="menu" class="nav-item"><a class="nav-link" href=""><b>Gắn dấu sao</b></a></li>
                        <div class="dropdown-divider"></div>
            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10">
                <h4><img src="./images/staricon.png" width="40" height="40" alt="folder icon">&thinsp;&thinsp;Gắn dấu sao</h4>
                <div>
                    <!-- Show NoteStar --> 
